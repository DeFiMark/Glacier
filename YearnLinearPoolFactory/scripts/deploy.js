...
const CONTRACT_NAME = "YearnLinearPoolFactory";
const PATH = "yearn/"; // no preceding slash but always trailing slash if there is a path
const FILE_NAME = "YearnLinearPoolFactory";
