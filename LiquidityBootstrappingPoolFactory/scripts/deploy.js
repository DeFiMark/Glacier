...
const CONTRACT_NAME = "LiquidityBootstrappingPoolFactory";
const PATH = "smart/"; // no preceding slash but always trailing slash if there is a path
const FILE_NAME = "LiquidityBootstrappingPoolFactory";
