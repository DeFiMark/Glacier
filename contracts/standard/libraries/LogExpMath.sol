...
library LogExpMath {
    ...
    function pow(uint256 x, uint256 y) internal pure returns (uint256) {
        ...
        Errors._require(x < 2**255, Errors.X_OUT_OF_BOUNDS);
        ...
        Errors._require(y < MILD_EXPONENT_BOUND, Errors.Y_OUT_OF_BOUNDS);
    ...
    function exp(int256 x) internal pure returns (int256) {
        Errors._require(x >= MIN_NATURAL_EXPONENT && x <= MAX_NATURAL_EXPONENT, Errors.INVALID_EXPONENT);
    ...
    function ln(int256 a) internal pure returns (int256) {
        ...
        Errors._require(a > 0, Errors.OUT_OF_BOUNDS);
