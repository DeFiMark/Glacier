    ...
    TwoTokenPoolsBalance
{
    ...
    function managePoolBalance(PoolBalanceOp[] memory ops) external override nonReentrant whenNotPaused {
        ...
        for (uint256 i = 0; i < ops.length; ++i) {
            ...
            Errors._require(_isTokenRegistered(poolId, token), Errors.TOKEN_NOT_REGISTERED);
            Errors._require(_poolAssetManagers[poolId][token] == msg.sender, Errors.SENDER_NOT_ASSET_MANAGER);
