...
abstract contract TwoTokenPoolsBalance is PoolRegistry {
    ...
    function _registerTwoTokenPoolTokens(
        ...
        Errors._require(tokenX != tokenY, Errors.TOKEN_ALREADY_REGISTERED);

        Errors._require(tokenX < tokenY, Errors.UNSORTED_TOKENS);
        ...
        Errors._require(poolTokens.tokenA == IERC20(0) && poolTokens.tokenB == IERC20(0), Errors.TOKENS_ALREADY_SET);
    ...
    function _deregisterTwoTokenPoolTokens(
        ...
        Errors._require(balanceA.isZero() && balanceB.isZero(), Errors.NONZERO_TOKEN_BALANCE);
