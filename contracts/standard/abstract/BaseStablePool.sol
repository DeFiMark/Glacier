...
import "./BalancerStablePoolToken.sol";
 ...
 */
abstract contract BaseStablePool is IBasePool, BasePoolAuthorization, BalancerStablePoolToken, TemporarilyPausable {
    ...
    constructor(
        ...
        BalancerStablePoolToken(name, symbol)
        BasePoolAuthorization(owner)
        TemporarilyPausable(pauseWindowDuration, bufferPeriodDuration)
    {
        Errors._require(tokens.length >= _MIN_TOKENS, Errors.MIN_TOKENS);
        Errors._require(tokens.length <= _MAX_TOKENS, Errors.MAX_TOKENS);
