...
contract WeightedPool is BaseMinimalSwapInfoStablePool, WeightedMath {
        ...
        )
    {
        ...
        for (uint8 i = 0; i < numTokens; i++) {
            ...
            Errors._require(normalizedWeight >= _MIN_WEIGHT, Errors.MIN_WEIGHT);
