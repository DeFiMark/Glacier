...
contract WeightedMath {
        ...
        returns (uint256 invariant)
    {
        ...
        **********************************************************************************************/
        ...
        Errors._require(invariant > 0, Errors.ZERO_INVARIANT);
    }
    ...
    function _calcOutGivenIn(
        ...
        **********************************************************************************************/
        ...
        Errors._require(amountIn <= balanceIn.mulDown(_MAX_IN_RATIO), Errors.MAX_IN_RATIO);
    ...
    function _calcInGivenOut(
        ...
        **********************************************************************************************/
        ...
        Errors._require(amountOut <= balanceOut.mulDown(_MAX_OUT_RATIO), Errors.MAX_OUT_RATIO);
    ...
    function _calcTokenInGivenExactBptOut(
        ...
        ******************************************************************************************/
        ...
        Errors._require(invariantRatio <= _MAX_INVARIANT_RATIO, Errors.MAX_OUT_BPT_FOR_TOKEN_IN);
    ...
    function _calcTokenOutGivenExactBptIn(
        ...
        *****************************************************************************************/
        ...
        Errors._require(invariantRatio >= _MIN_INVARIANT_RATIO, Errors.MIN_BPT_IN_FOR_TOKEN_OUT);
